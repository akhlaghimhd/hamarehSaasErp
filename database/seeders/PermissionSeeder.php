...
class PermissionSeeder extends Seeder
{
    ...
    private function getBasePermissions(): array
    {
        return [
            ...
            ['code' => 'partner.partner_user.create', 'name' => 'Create Partner User', 'module_name' => 'PartnerLayer', 'action_type' => 'CREATE'],
            ['code' => 'partner.partner_user.update', 'name' => 'Update Partner User', 'module_name' => 'PartnerLayer', 'action_type' => 'UPDATE'],
            ['code' => 'partner.partner_user.delete', 'name' => 'Delete Partner User', 'module_name' => 'PartnerLayer', 'action_type' => 'DELETE'],

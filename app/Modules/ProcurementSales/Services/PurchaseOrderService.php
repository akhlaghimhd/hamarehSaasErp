...
use App\Modules\ProcurementSales\Services\Concerns\PurchaseOrderWorkflowSupport;
...
{
    use PurchaseOrderWorkflowSupport;
    ...
    /** Pending workflow approval (L6-WF-04 extension for PO). */
    public const STATUS_PENDING_APPROVAL = 5;

...
use App\Modules\ProcurementSales\Services\Concerns\SalesInvoiceWorkflowSupport;
...
/**
 * L6-PS-07 – Sales Invoice create/post; L6-PS-08 schedule; L6-PS-10 workflow.
 */
class SalesInvoiceService
{
    use SalesInvoiceWorkflowSupport;
    ...
    public function create(CreateSalesInvoiceDTO $dto): SalesInvoice
    {
        return DB::transaction(function () use ($dto) {
            ...
            $subtotal = $taxTotal = $discountTotal = 0.0;
    ...
    public function post(string $id): SalesInvoice
    {
        return DB::transaction(function () use ($id) {
            ...
            if (!in_array((int) $invoice->status, [self::STATUS_DRAFT, self::STATUS_APPROVED], true)) {
                throw new ConflictHttpException('Only draft or approved sales invoices can be posted.');
            }

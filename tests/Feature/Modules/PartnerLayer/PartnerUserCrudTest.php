...
/**
 * L3 PartnerUser CRUD Feature Tests.
 */
class PartnerUserCrudTest extends TestCase
{
    ...
    public function authorized_user_can_link_user_to_partner(): void
    {
        $response = $this->withHeaders($this->authHeaders())
            ->postJson('/api/v1/partner-layer/partner-users', [
    ...
    public function authorized_user_can_list_partner_users(): void
    {
        ...
        $response = $this->withHeaders($this->authHeaders())
            ->getJson('/api/v1/partner-layer/partner-users?partner_id=' . $this->partner->partner_id);
    ...
    public function authorized_user_can_update_partner_user(): void
    {
        ...
        $response = $this->withHeaders($this->authHeaders())
            ->putJson('/api/v1/partner-layer/partner-users/' . $pu->partner_user_id, [
                'is_primary' => true,
                'status'     => 1,
            ]);
    ...
    public function authorized_user_can_soft_delete_partner_user(): void
    {
        ...
        $response = $this->withHeaders($this->authHeaders())
            ->deleteJson('/api/v1/partner-layer/partner-users/' . $pu->partner_user_id);
    ...
    {
        $response = $this->postJson('/api/v1/partner-layer/partner-users', [
            'partner_id' => $this->partner->partner_id,
            'user_id'    => $this->linkedUser->user_id,
        ]);

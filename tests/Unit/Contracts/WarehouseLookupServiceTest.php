...
class WarehouseLookupServiceTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->service = app(WarehouseLookupContract::class);
    ...
    #[Test]
    public function it_is_bound_to_warehouse_lookup_contract(): void
    {
        $this->assertInstanceOf(WarehouseLookupService::class, $this->service);
    }

...
/** Event type: inventory.stock.reservation_released.v1 */
final class StockReservationReleasedV1
{
    public const EVENT_TYPE = 'inventory.stock.reservation_released.v1';

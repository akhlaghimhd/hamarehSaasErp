...
class OrganizationCrudAndIsolationTest extends TestCase
{
    ...
    public function can_create_list_show_update_and_soft_delete_company(): void
    {
        ...
        $this->assertSame(2, (int) $softDeleted->row_version);
    ...
    public function branch_and_department_update_increments_row_version(): void
    {
        ...
        $branchUpdate = $this->withHeaders($this->authHeaders($this->tokenA, $this->tenantA->tenant_id))
            ->putJson('/api/organization/branches/' . $branchId, [
                'code'      => 'BR-RV-01-UPD',
                'name'      => 'Row Version Branch Updated',
                'is_active' => true,
            ]);
        $branchUpdate->assertStatus(200);

...
/**
 * P3-T3 — PartnerAgreement CRUD feature tests.
 */
class PartnerAgreementCrudTest extends TestCase
{
    ...
    public function authorized_user_can_create_agreement(): void
    {
        $response = $this->withHeaders($this->authHeaders())
            ->postJson('/api/v1/partner-layer/partner-agreements', [
    ...
    public function authorized_user_can_list_agreements(): void
    {
        ...
        $response = $this->withHeaders($this->authHeaders())
            ->getJson('/api/v1/partner-layer/partner-agreements?partner_id=' . $this->partner->partner_id);
    ...
    public function authorized_user_can_update_agreement(): void
    {
        ...
        $response = $this->withHeaders($this->authHeaders())
            ->putJson('/api/v1/partner-layer/partner-agreements/' . $agreement->agreement_id, [
                'description' => 'After',
            ]);
    ...
    public function authorized_user_can_soft_delete_agreement(): void
    {
        ...
        $response = $this->withHeaders($this->authHeaders())
            ->deleteJson('/api/v1/partner-layer/partner-agreements/' . $agreement->agreement_id);

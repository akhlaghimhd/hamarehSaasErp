...
class PermissionSeeder extends Seeder
{
    ...
    private function getBasePermissions(): array
    {
        return [
            ...
            // Organization
            ['code' => 'organization.company.view', 'name' => 'View Companies', 'module_name' => 'Organization', 'action_type' => 'CREATE'],
            ...
            // Procurement & Sales - Purchase Order
            ...
            ['code' => 'procurement.purchase-order.update', 'name' => 'Update Purchase Order', 'module_name' => 'ProcurementSales', 'action_type' => 'UPDATE'],
            ['code' => 'procurement.purchase-order.delete', 'name' => 'Delete Purchase Order', 'module_name' => 'ProcurementSales', 'action_type' => 'DELETE'],
            ['code' => 'procurement.purchase-order.post', 'name' => 'Post Purchase Order', 'module_name' => 'ProcurementSales', 'action_type' => 'EXECUTE'],

            // Procurement & Sales - Purchase Receipt
            ['code' => 'procurement.purchase-receipt.view', 'name' => 'View Purchase Receipts', 'module_name' => 'ProcurementSales', 'action_type' => 'READ'],
            ['code' => 'procurement.purchase-receipt.create', 'name' => 'Create Purchase Receipt', 'module_name' => 'ProcurementSales', 'action_type' => 'CREATE'],
            ['code' => 'procurement.purchase-receipt.update', 'name' => 'Update Purchase Receipt', 'module_name' => 'ProcurementSales', 'action_type' => 'UPDATE'],
            ['code' => 'procurement.purchase-receipt.delete', 'name' => 'Delete Purchase Receipt', 'module_name' => 'ProcurementSales', 'action_type' => 'DELETE'],
            ['code' => 'procurement.purchase-receipt.post', 'name' => 'Post Purchase Receipt', 'module_name' => 'ProcurementSales', 'action_type' => 'EXECUTE'],

            // Procurement & Sales - Sales Quotation
            ['code' => 'procurement.sales-quotation.view', 'name' => 'View Sales Quotations', 'module_name' => 'ProcurementSales', 'action_type' => 'READ'],
            ['code' => 'procurement.sales-quotation.create', 'name' => 'Create Sales Quotation', 'module_name' => 'ProcurementSales', 'action_type' => 'CREATE'],
            ['code' => 'procurement.sales-quotation.update', 'name' => 'Update Sales Quotation', 'module_name' => 'ProcurementSales', 'action_type' => 'UPDATE'],
            ['code' => 'procurement.sales-quotation.delete', 'name' => 'Delete Sales Quotation', 'module_name' => 'ProcurementSales', 'action_type' => 'DELETE'],

            // Procurement & Sales - Sales Order
            ['code' => 'procurement.sales-order.view', 'name' => 'View Sales Orders', 'module_name' => 'ProcurementSales', 'action_type' => 'READ'],
            ['code' => 'procurement.sales-order.create', 'name' => 'Create Sales Order', 'module_name' => 'ProcurementSales', 'action_type' => 'CREATE'],
            ['code' => 'procurement.sales-order.update', 'name' => 'Update Sales Order', 'module_name' => 'ProcurementSales', 'action_type' => 'UPDATE'],
            ['code' => 'procurement.sales-order.delete', 'name' => 'Delete Sales Order', 'module_name' => 'ProcurementSales', 'action_type' => 'DELETE'],
            ['code' => 'procurement.sales-order.confirm', 'name' => 'Confirm Sales Order', 'module_name' => 'ProcurementSales', 'action_type' => 'EXECUTE'],

            // Procurement & Sales - Sales Delivery
            ['code' => 'procurement.sales-delivery.view', 'name' => 'View Sales Deliveries', 'module_name' => 'ProcurementSales', 'action_type' => 'READ'],
            ['code' => 'procurement.sales-delivery.create', 'name' => 'Create Sales Delivery', 'module_name' => 'ProcurementSales', 'action_type' => 'CREATE'],
            ['code' => 'procurement.sales-delivery.update', 'name' => 'Update Sales Delivery', 'module_name' => 'ProcurementSales', 'action_type' => 'UPDATE'],
            ['code' => 'procurement.sales-delivery.delete', 'name' => 'Delete Sales Delivery', 'module_name' => 'ProcurementSales', 'action_type' => 'DELETE'],
            ['code' => 'procurement.sales-delivery.post', 'name' => 'Post Sales Delivery', 'module_name' => 'ProcurementSales', 'action_type' => 'EXECUTE'],

            // Procurement & Sales - Return Order
            ['code' => 'procurement.return-order.view', 'name' => 'View Return Orders', 'module_name' => 'ProcurementSales', 'action_type' => 'READ'],
            ['code' => 'procurement.return-order.create', 'name' => 'Create Return Order', 'module_name' => 'ProcurementSales', 'action_type' => 'CREATE'],
            ['code' => 'procurement.return-order.update', 'name' => 'Update Return Order', 'module_name' => 'ProcurementSales', 'action_type' => 'UPDATE'],
            ['code' => 'procurement.return-order.delete', 'name' => 'Delete Return Order', 'module_name' => 'ProcurementSales', 'action_type' => 'DELETE'],

            // L6-PS-07 Sales / Purchase Invoices

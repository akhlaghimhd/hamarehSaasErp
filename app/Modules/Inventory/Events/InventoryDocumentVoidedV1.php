...
/**
 * Integration event — emitted when a posted inventory document is voided and stock reversed.
 * Event type string: inventory.document.voided.v1
 */
final class InventoryDocumentVoidedV1
{
    public const EVENT_TYPE = 'inventory.document.voided.v1';
